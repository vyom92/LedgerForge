...
struct DeveloperDatabaseProfilePresentationTests {
    ...
    func everyNonCurrentProfileHasBoundedWarning(_ kind: DevelopmentDatabaseProfileKind) {
        ...
        #expect(presentation?.currentSchema == "Current schema V12")
    ...
    func controlsExposeExactSafeLabelsAndHistoricalVersions() {
        ...
        #expect(DevelopmentDatabaseProfile.registeredHistoricalSourceVersions == Array(1...11))
        ...
        #expect(descriptor(kind: .migrationSandbox, sourceVersion: 11).currentSchemaLabel == "V12")
    }
