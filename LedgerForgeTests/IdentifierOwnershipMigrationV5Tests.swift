...
struct IdentifierOwnershipMigrationV5Tests {
    ...
    @Test func v5PreflightRejectsOrphanedIdentifierWithoutLeavingVersionFive() throws {
        ...
        try database.runMigrations(Array(allMigrations.prefix(4)))
        ...
        #expect(throws: MigrationPreflightError.failed(issueCode: "identifier-missing-account")) { try database.runMigrations(allMigrations) }
