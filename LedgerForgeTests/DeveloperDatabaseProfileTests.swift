...
struct DeveloperDatabaseProfileTests {
    ...
    @Test func profileDescriptorsAndResultsArePathFree() throws {
        ...
        #expect(descriptor.migrationSourceVersion == 13)
    ...
    @Test func malformedPreferencesFallBackWithoutReopeningOwnedProfiles() throws {
        ...
        defaults.set(14, forKey: DevelopmentDatabaseProfilePreferences.rememberedMigrationSourceVersionKey)
        ...
        #expect(preferences.rememberedMigrationSourceVersion == 13)
    }
