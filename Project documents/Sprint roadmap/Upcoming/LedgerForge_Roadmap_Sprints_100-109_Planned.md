...
The real database entering this gate is the populated adoption candidate produced by the [Sprint-98 qualification and frozen final-population campaign](../LedgerForge_Roadmap_Sprints_90-99_Current.md#sprint-98-qualification-and-adoption-population), carried through accepted Sprint-99 reporting/net-worth work. Verify its exact candidate/build and qualified source-set identity, canonical persisted/hydrated data and coverage/held-source reconciliation. It must not be a mixture of parser versions accumulated during investigation. Sprint 100 verifies that candidate and the adopted whole-app workflow; it is not a second population or parser-implementation sprint. Personal-v1 remains not adopted until the owner accepts the completed gate.
