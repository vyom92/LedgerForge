...
Before every sprint decision, Chat must inspect the exact current repository ref, the current roadmap, `PROJECT_STATE.md`, `FUTURE_WORK.MD`, accepted ADRs and relevant code/tests. Repository evidence overrides this roadmap.
...
- **Archived roadmap:** Repository-visible historical planning context; not execution authority.
...
- treat this archived roadmap as historical context, not execution authority.
...
6. create the next Sprints 70–79 roadmap;
