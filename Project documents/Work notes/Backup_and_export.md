...
**Sprint-97 accepted alignment, 2026-09-17:** the owner-authorized authenticated ZIO source adds V22 nullable statement provenance with an explicit source-kind check in the existing investment tables. V1–V21 identities remain immutable. Format 1 is unchanged; exact V17–V21 packages verify before applying their missing registered tail in isolation, and V22 verifies directly. Native-source live qualification passed populated V22 backup/restore and reopen, including the complete account receipt. The [accepted outcome](../Archive/Accepted%20outcomes/Sprints_90-99.md#sprint-97) and [owning note](Holdings_and_valuation.md#sprint-97-implementation-evidence) record builds, schema expectations, source coverage and retained limits. Current was independently used by the owner before closure; root qualification used isolated namespaces. Publication performs no Current activation, restore or credential change.

**Sprint-96 accepted alignment, 2026-09-17:** additive V21 includes current investment containers/holdings in the existing format-1 package. Exact V17–V20 isolated upgrade mechanics, populated V21 replacement/hydration and real isolated restore/relaunch passed. Qualification preserved current records/provenance, the original package hash and the owner's V20 Current database. [Accepted Sprint 96](../Archive/Accepted%20outcomes/Sprints_90-99.md#sprint-96) owns the publication-first activation sequence; [Holdings and valuation](Holdings_and_valuation.md#current-conclusion) retains exact results and source limits. Closure does not rerun completed recovery qualification. After implementation commit `759be9fed485603bdea1bd9e8192372738233208` was pushed, the established startup gate activated actual Current V20→V21 and passed clean relaunch with unchanged existing rows; only the two empty investment tables were added.
