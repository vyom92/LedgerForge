...
The original private statements remain read-only evidence in their approved source location. The then-available two NRE and two NRO private CSV families independently provided 94 and 35 observable row-to-row balance deltas respectively, all conventional. The legacy 81-row/31-row NRE fixtures and synthetic partial-overlap pair lacked immutable transformation lineage and were not source truth; they are now retired and may not execute as mechanics or financial-source inputs.
