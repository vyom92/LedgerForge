...
**Latest accepted numbered implementation: Sprint 90 — R1 Dashboard Native-Currency Hierarchy**, `619c39ec07402a63c90b646cbba9ced806f5e99d`, accepted under `SPRINT_90_DASHBOARD_NATIVE_CURRENCY_HIERARCHY_ACCEPTED` (parent baseline `5b10baa33db653c0c8a263d7acb0805a17be628a`). Native targets use Swift 6. The current accepted migration is **V17**; V1–V16 remain immutable. No V18 is authorized. Exact DDL is owned by the [registered migrations](../Database/Migrations.swift), architecture by [ADRs](ADR.md), and persistence boundaries by [Database architecture](Database_v1_Architecture.md).

Chat accepted Sprint 90 on 2026-09-12 at the implementation ref above. This documentation closure records the accepted evidence without rerunning tests, builds, native acceptance, database comparison or a parser/source campaign. **PERSONAL-V1: NOT YET ADOPTED.** The owner-required outcome and exclusions live in [SCOPE_DECISIONS](SCOPE_DECISIONS.md), with the prepared [Sprint 100 personal-adoption gate](Sprint%20roadmap/Upcoming/LedgerForge_Roadmap_Sprints_100-109_Planned.md).
...
[Sprints 90–99](Sprint%20roadmap/LedgerForge_Roadmap_Sprints_90-99_Current.md) is the **CURRENT numbering authority**, explicitly activated through accepted Sprint 90. Sprint 90 completed FW-P2-78 and only the necessary Dashboard portions of FW-P2-48/50; its [accepted outcome](Archive/Accepted%20outcomes/Sprints_90-99.md#sprint-90) owns the detailed evidence, crash correction, non-runs and limitations. Sprint 91 remains **PREPARED / NOT YET CHAT-AUTHORIZED**, **NOT YET IMPLEMENTED / NOT YET ACCEPTED**. Sprint 92 remains unimplemented, with its residual scope requiring a refreshed SC-05A after Sprint 91. The 100–109 roadmap remains non-current.
...
| Dashboard | Accepted Sprint 90 groups repository-backed bank positions by native currency while keeping card liabilities separate, with no cross-currency total or hidden FX. Authoritative source/as-of context, explicit unavailable positions/dates, saved current-month Salary/Funding results, read-only Recent Activity, genuine Import Activity and conditional explicit review-required Attention are accepted. Responsive layouts at 1440 × 900, 1024 × 768, 768 × 768 and 640 × 768, constrained rail, destination sizing transitions and the three approved actions are accepted without financial/database writes. |
...
| UI direction | [R1 package](UI%20Assets/LF-UI-2026-09-R1/README.md) owns the approved written visual direction and published design references. SC-01/SC-02 informed accepted Sprint 89; SC-03 A/B/C are implemented by accepted Sprint 90. SC-04 A/B/C remain published but unimplemented. SC-05A remains the accepted audit to refresh after Sprint 91 before Sprint-92 implementation. |
...
| --- | --- |
| [Sprints 90–99](Archive/Accepted%20outcomes/Sprints_90-99.md) | Sprint 90, 2026-09-12; Dashboard hierarchy, bounded day-change correction and accepted validation/limitations |
