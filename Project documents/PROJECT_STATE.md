...
- Primary branch: `main`.
- Latest verified completed increment: Sprint 44 — Deterministic Money and Native-Currency Integrity.
- Latest relevant implementation commit: `00d25ce60655ba71b2f75da68f3561e86cfe76b9` — Implement deterministic Money boundary.
...
- Build state: clean Debug build passing for Sprint 44.
- Latest verified automated result: 235 tests in 34 suites, 0 failures, 0 skipped. Generic `LedgerForgeUITests` remained intentionally disabled.
