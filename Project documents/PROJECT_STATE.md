...
## PRIVATE PERSONAL APP SCOPE RESET — 2026-09-11

**Explicit owner decision:** LedgerForge is private, personal, single-user, macOS-native and offline-first, for the owner's own finances on the owner's MacBook. The Private Personal App Scope Gate now precedes planning/discovery and P0 → P3 triage. Generalized public/commercial/platform work is **NOT REQUIRED-DO NOT CONSIDER**, not deferred or post-v1. The [canonical rejection register](FUTURE_WORK.MD#rejected-private-personal-scope) owns the excluded IDs; rejected work cannot block retained work or reappear without a new explicit owner decision naming a real personal need.

**Scope correction:** formal accessibility closure is rejected. Sprint 89 no longer consumes FW-P2-49; its necessary Transactions usability remains under FW-P2-03/53 and bounded FW-P2-48/50. Sprint 91 becomes simple device-local appearance under FW-P2-52 only; Sprint 92 becomes actual cross-screen visual/interaction polish. Sprint 100 becomes LedgerForge 1.0 Personal Adoption Verification. **PERSONAL-V1: NOT YET ADOPTED.**

**Owner clarifications:** retain FW-P0-18 and FW-P1-30/34/35/38/39/39A only as bounded single-user MacBook workflows. Remove the ten unselected source-family placeholders, five additional unselected event/card/relationship/parity/stress placeholders, and the app-level encryption candidate because the owner identifies no current concern. Keep FW-P0-19 only for the existing three Axis-bank source groups; remove the unspecified CI/UI-smoke/distribution candidate while preserving accepted local validation. Preserve useful design PNGs and explicitly ignore their rejected caption portions; current written authority controls. The narrowed queue contains 106 active cards, with 39 rejected IDs and one separate appearance card consolidated.

**Accepted behavior and financial rigor:** existing useful Developer Console, immediate recovery guidance, exact Keychain families, native SwiftUI semantics, local signing/sandbox and current workspace schema remain. ADR-046 authentic-source-only input, complete corpus, independent source oracles, exact native Money/dates/order/identity, duplicate/equivalence, explicit confirmation, provider-owned atomic persistence, zero-residue rejection, migration integrity, SQLite checks, hydration/relaunch, password privacy, protected originals and required verified backup/restore remain binding. No new ADR, migration, product implementation or source-support expansion is accepted by this correction.

**Sprint-89 interlock:** existing local product/project/test WIP is preserved as unaccepted work and remains paused for the documentation reset. The published correction supplies the new documentation baseline; continuation requires a fresh exact-ref preflight against the corrected complete execution contract. This reset does not mark Sprint 89 accepted. Accepted Sprint-88 and earlier records below remain historical facts; superseded future-scope wording in those records is not current planning authority.

## Published discovery index — 2026-09-10

**Discovery reconciliation — 2026-09-10:** both read-only discovery rounds are incorporated in the existing [FUTURE_WORK](FUTURE_WORK.MD#discovery-reconciled-into-existing-subject-authorities--2026-09-10), current/prepared roadmaps and R1 DESIGN_HANDOFF. The redundant standalone register is retired. Findings and decision packets remain proposals unless explicitly identified as settled user scope; this documentation does not accept implementation, migrations, source support, a sprint or personal adoption. Historical discovery counts and rejected proposals are superseded by the 2026-09-11 scope reset. The existing accepted-state and current-sprint records below remain authoritative.
...
- **Latest accepted numbered implementation:** Sprint 88 — App Shell and Workflow Decomposition at `4f5eeb7b11c0f5879204a06ae9f08045304342b5`. All native targets are Swift 6. Sprint 79 remains the latest numbered financial-domain feature implementation, and historical Sprint 70–79 implementation/acceptance records remain intact.
...
- **Personal-v1 parser reliability:** the complete registered 127-carrier corpus was recertified through ordinary production by the accepted unnumbered reset; personal-v1 remains **NOT YET ADOPTED** and requires a separate owner adoption verification gate.
...
- **Documentation alignment:** Reconciled for accepted Sprints 81–88 and planned, not-yet-Chat-authorized Sprint 89, the accepted unnumbered reset, additive V17, the Sprint 79 financial-domain implementation and the accepted Sprint 80 readiness-discovery boundary
